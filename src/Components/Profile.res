  ...
  <section id="profile" className="bg-[#1D204B] rounded-2xl">
    <div
      ...
      <div className="flex flex-col gap-3">
        ...
        <h1 className="text-4xl font-thin text-white"> {"Jeremy Robson"->React.string} </h1>
      </div>
    </div>
    <div
      id="times"
      ...
      <div
        ...
        onClick={_ => timeChanger(_ => Daily)}>
        {"Daily"->React.string}
      </div>
      <div
        id="card"
        className="hover:text-white hover:text-lg cursor-pointer"
        onClick={_ => timeChanger(_ => Weekly)}>
        {"Weekly"->React.string}
      </div>
      <div
        id="card"
        className="hover:text-white hover:text-lg cursor-pointer"
        onClick={_ => timeChanger(_ => Monthly)}>
        {"Monthly"->React.string}
      </div>
    </div>
  </section>
}
